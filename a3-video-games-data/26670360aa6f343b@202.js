...
import define1 from "./a2e58f97fd5e8d7c@669.js";
...
`
  ...
  main.variable(observer("vl")).define("vl", ["vegaVersion","vlVersion","apiVersion","tooltipVersion","require"], async function(vegaVersion,vlVersion,apiVersion,tooltipVersion,require)
{
  ...
  main.variable(observer("apiVersion")).define("apiVersion", function(){return(
'5.0.0'
)});
  main.variable(observer("vlVersion")).define("vlVersion", function(){return(
'5.0.0'
)});
  main.variable(observer("vegaVersion")).define("vegaVersion", function(){return(
'5.20.2'
)});
  main.variable(observer("tooltipVersion")).define("tooltipVersion", function(){return(
'0.25.1'
)});
  main.variable(observer()).define(["md"], function(md){return(
  ...
  main.variable(observer()).define(["vl","width"], function(vl,width)
{
  ...
  main.variable(observer("population_pyramid")).define("population_pyramid", ["md"], function(md){return(
md`<hr/>
## Population Pyramid
...
A [population pyramid](https://en.wikipedia.org/wiki/Population_pyramid) shows the distribution of age groups in a population. Drag the slider to see the U.S. change over time, but watch out for [missing data in 1890!](https://www.census.gov/history/www/faqs/genealogy_faqs/why_cant_i_find_1890_census_records.html) The slider is generated internally by binding the \`Year\` parameter using \`vl.slider()\`.`
  ...
  main.variable(observer()).define(["vl"], function(vl){return(
vl.markBar({ opacity: 0.4 })
  ...
  main.variable(observer("bind_external")).define("bind_external", ["md"], function(md){return(
...
As an alternative to having Vega-Lite generate its own input widgets (as with \`vl.slider()\` above), we can also directly bind a Vega-Lite parameter to an existing widget, such as Observable's \`Range\` component:`
  ...
  main.variable(observer("viewof year")).define("viewof year", ["Range"], function(Range){return(
Range([1850, 2000], { step: 10, value: 2000 })
)});
  main.variable(observer("year")).define("year", ["Generators", "viewof year"], (G, _) => G.input(_));
  main.variable(observer()).define(["vl","viewof year"], function(vl,$0){return(
vl.markBar({ opacity: 0.4 })
  .params(
  ...
  main.variable(observer("dynamic_scatter")).define("dynamic_scatter", ["md"], function(md){return(
md`<hr/>
...
A scatter plot of automobile mileage and horsepower. (Shift-)Click the legend and drag the slider to filter by Origin and Year.`
  ...
  main.variable(observer()).define(["vl"], function(vl)
{
  ...
  main.variable(observer()).define(["vl","width"], function(vl,width)
{
  ...
  main.variable(observer("standalone_use")).define("standalone_use", ["md","apiVersion"], function(md,apiVersion){return(
md`<hr/>
